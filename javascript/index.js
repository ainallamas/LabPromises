...
getInstruction("mashedPotatoes", 4, (step4) => {
  ...
  //To remove the "hidden" attribute form an <a> element: 
...
//todas las promesas en el argumento iterable han sido concluídas con éxito, o bien
//rechaza la petición con el motivo pasado por la primera promesa que es rechazada.

//Primero hacemos una función con los pasos: 
...
Promise.all([step0, step1, step2, step3, step4, step5, step6, step7, step8]).then((recipe) => {
